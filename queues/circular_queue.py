...
class CircularQueue:
    def __init__(self, capacity: int):
        ...
        Notes:
            'self.front' (int): index of the first element. If is -1, the circular queue is empty.
            'self.rear' (int): index of the last added element. If is (4+1) % 5 = 0 than the circular queue is full.
        """
